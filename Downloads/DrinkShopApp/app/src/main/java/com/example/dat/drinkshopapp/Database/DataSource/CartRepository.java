...
public class CartRepository implements ICartDataSoure   {

    private ICartDataSoure iCartDataSource;

    public CartRepository(ICartDataSoure iCartDataSource) {
        this.iCartDataSource = iCartDataSource;
    }

    private static CartRepository instance;

    public static CartRepository getInstance(ICartDataSoure iCartDataSource) {
        if (instance == null)
